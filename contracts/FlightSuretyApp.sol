...
interface FlightSuretyData {
    ...
    function buy(address payable insureeAccount, address airlineAccount, 
        string calldata airlineName, uint256 timestamp) external payable;

    function getAmountPaidByInsuree(address payable insureeAccount, address airlineAccount, 
        string calldata airlineName, uint256 timestamp) external view returns(uint256 amountPaid);

    function creditInsurees(uint256 creditPercentage, address airlineAccount, 
        string calldata airlineName, uint256 timestamp) external;
